...
plt.savefig("ROC Curve Decision Tree F Score Feature Selection (SMOTE).png")
plt.show()
...
plt.savefig("ROC Curve Decision Tree F Score Feature Selection (BSMOTE).png")
plt.show()

# SMOTE Metrics
df_4.loc[len(df_4.index)] = ['Decision Tree', 'F Score Feature Selection', 'Heart Attack = 1', accuracy_1, tpr_1, fpr_1, precision_1, recall_1, fscore_1, mcc_1, roc_1, con_mat_1[0][0], con_mat_1[0][1], con_mat_1[1][0], con_mat_1[1][1]]
df_4.loc[len(df_4.index)] = ['Decision Tree', 'F Score Feature Selection', 'Heart Attack = 2', accuracy_1, tpr_2, fpr_2, precision_2, recall_2, fscore_2, mcc_2, roc_2, con_mat_1[0][0], con_mat_1[0][1], con_mat_1[1][0], con_mat_1[1][1]]
df_4.loc[len(df_4.index)] = ['Decision Tree', 'F Score Feature Selection', 'Weighted', accuracy_1, tpr_w1, fpr_w1, precision_w1, recall_w1, fscore_w1, mcc_w1, roc_w1, con_mat_1[0][0], con_mat_1[0][1], con_mat_1[1][0], con_mat_1[1][1]]

# Borderline SMOTE
df_5.loc[len(df_5.index)] = ['Decision Tree', 'F Score Feature Selection', 'Heart Attack = 1', accuracy_2, tpr_3, fpr_3, precision_3, recall_3, fscore_3, mcc_3, roc_3, con_mat_2[0][0], con_mat_2[0][1], con_mat_2[1][0], con_mat_2[1][1]]
df_5.loc[len(df_5.index)] = ['Decision Tree', 'F Score Feature Selection', 'Heart Attack = 2', accuracy_2, tpr_4, fpr_4, precision_4, recall_4, fscore_4, mcc_4, roc_4, con_mat_2[0][0], con_mat_2[0][1], con_mat_2[1][0], con_mat_2[1][1]]
df_5.loc[len(df_5.index)] = ['Decision Tree', 'F Score Feature Selection', 'Weighted', accuracy_2, tpr_w2, fpr_w2, precision_w2, recall_w2, fscore_w2, mcc_w2, roc_w2, con_mat_2[0][0], con_mat_2[0][1], con_mat_2[1][0], con_mat_2[1][1]]
