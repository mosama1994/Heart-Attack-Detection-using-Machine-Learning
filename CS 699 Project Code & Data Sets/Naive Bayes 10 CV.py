...
plt.savefig("Naive Bayes 10 CV ROC Curve.png")
plt.show()
print(con_mat_1)
...
df_2.loc[len(df_2.index)] = ['Naive Bayes', 'Heart Attack = 1', accuracy / 10, tpr_1 / 10, fpr_1 / 10, precision_1 / 10, recall_1 / 10, fscore_1 / 10, mcc_1 / 10, roc_1 / 10, con_mat_1[0][0], con_mat_1[0][1], con_mat_1[1][0], con_mat_1[1][1]]
df_2.loc[len(df_2.index)] = ['Naive Bayes', 'Heart Attack = 2', accuracy / 10, tpr_2 / 10, fpr_2 / 10, precision_2 / 10, recall_2 / 10, fscore_2 / 10, mcc_2 / 10, roc_2 / 10, con_mat_1[0][0], con_mat_1[0][1], con_mat_1[1][0], con_mat_1[1][1]]
df_2.loc[len(df_2.index)] = ['Naive Bayes', 'Weighted', accuracy / 10, tpr_w / 10, fpr_w / 10, precision_w / 10, recall_w / 10, fscore_w / 10, mcc_w / 10, roc_w / 10, con_mat_1[0][0], con_mat_1[0][1], con_mat_1[1][0], con_mat_1[1][1]]
